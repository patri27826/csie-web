# Generated by Django 3.1.2 on 2022-07-20 08:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='courseinfo',
            options={'verbose_name_plural': '課程介紹'},
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='education.courseinfo')),
            ],
            options={
                'verbose_name': 'course info Translation',
                'db_table': 'education_courseinfo_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
