...
from .models import Other, Alumni, TextInfo, Type

@admin.register(Other)
class OtherAdmin(TranslatableAdmin, SummernoteModelAdmin):
    list_display = ('title', 'content', 'link')
    summernote_fields = ('content',)

# @admin.register(Alumni)
# class AlumniAdmin(TranslatableAdmin, SummernoteModelAdmin):
#     list_display = ('title', 'content', 'link')
#     summernote_fields = ('content',)
